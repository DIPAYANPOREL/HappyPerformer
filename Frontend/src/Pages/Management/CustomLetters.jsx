...
const CustomLetters = () => {
  const [Letters, setLetters] = useState(['HI', 'Hello','How are you?', 'Thank you', 'Welcome', 'Goodbye', 'Good morning', 'Good afternoon', 'Good evening', 'Good night']);
  const [newLetterName, setNewLetterName] = useState('');

  const handleCreateLetter = () => {
    if (newLetterName.trim()) {
      setLetters([...Letters, newLetterName.trim()]);
      setNewLetterName('');
    }
  };
      ...
      <Container>
        ...
        <Content>
          <YourLettersContainer>
            <h3>Your Letters</h3>
            {Letters.length === 0 ? (
              <NoLettersText> No letters available. Please create a letter to see it here.</NoLettersText>
            ) : (
              <LetterList>
          ...
          <CreateLetterContainer>
            ...
            />
            <CreateLetterButton onClick={handleCreateLetter}>Create</CreateLetterButton>
          </CreateLetterContainer>
        </Content>
      </Container>
      <Footer />
