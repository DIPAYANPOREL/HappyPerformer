    ...
    const fetchFamilyDetails = async () => {
      try {
        const response = await axios.get(
          "http://127.0.0.1:8000/UpdateFamilyDetails/"
        );
    ...
    try {
      ...
      if (editIndex !== null) {
        response = await axios.put(
          `http://127.0.0.1:8000/UpdateFamilyDetails/${familyDetails[editIndex].id}`,
          newDetails
        );
          ...
          <Form onSubmit={saveDetails}>
            ...
            <FormSection>
              ...
              <FormInput
                ...
                defaultValue={
                  editIndex !== null ? familyDetails[editIndex].name : ""
                }
                required
              />
            ...
            <FormSection>
              ...
              <select
                ...
                name="gender"
                defaultValue={
                  editIndex !== null ? familyDetails[editIndex].gender : ""
                }
              >
            ...
            <FormSection>
              ...
              <FormInput
                ...
                defaultValue={
                  editIndex !== null ? familyDetails[editIndex].dob : ""
                }
              />
            </FormSection>
            <FormSection>
              ...
              <FormInput
                ...
                defaultValue={
                  editIndex !== null
                    ? familyDetails[editIndex].contactnumber
                    : ""
                }
              />
            </FormSection>
            <FormSection>
              ...
              <FormInput
                ...
                defaultValue={
                  editIndex !== null ? familyDetails[editIndex].email : ""
                }
              />
            </FormSection>
            <FormSection>
              ...
              <select
                ...
                name="relation"
                defaultValue={
                  editIndex !== null ? familyDetails[editIndex].relation : ""
                }
              >
                <option disabled value="">
                  Please Select
            ...
            <FormSection>
              ...
              <FormInput
                ...
                defaultValue={
                  editIndex !== null ? familyDetails[editIndex].comments : ""
                }
              />
            </FormSection>
